---
title: "D0_pseudobulk_blscore_mono"
...
## Get GSVA score of the filtered pseudobulk objects for Fig 1f-1g
...
**Generate Figure 1f-1g boxplots**  
...
module.scores.df <- left_join(module.scores.df, 
                              meta,
                              by=c("sample"))
write.csv(module.scores.df, file.path(OUT_DIR, "module_score_gsva_filtered_samples_genes_df.Mono.M4M11.baseline.csv"))
```
  
Boxplots of module scores
```{r boxplot, fig.width=17, fig.height=6}
# module.scores.df <- read.csv(paste0(OUT_DIR, "module_score_gsva_filtered_samples_genes_df.Mono.M4M11.baseline.csv"), row.names = 1)
